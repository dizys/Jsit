 ...
 public class ASTExclusiveOrExpressionVisitor
   extends Visitor
 {
   public ASTExclusiveOrExpressionVisitor(SimpleNode node, Object data)
   {
     super(node, data);
   }
   ...
   public void visitChildren(JsitParserVisitor defaultVisitor)
   {
     ...
     int i = 0;
     while ((this.node.jjtGetChild(++i) instanceof ASTAndExpression))
     {
       add(" ^ ");
