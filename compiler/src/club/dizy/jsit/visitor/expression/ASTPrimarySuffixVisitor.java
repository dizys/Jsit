 ...
 public class ASTPrimarySuffixVisitor
   extends Visitor
 {
   public ASTPrimarySuffixVisitor(SimpleNode node, Object data)
   {
     super(node, data);
   }
   ...
   public void visitChildren(JsitParserVisitor defaultVisitor)
   {
     ...
     else if ((this.node.jjtGetFirstChild() instanceof ASTAllocationExpression))
     {
       add(".");
