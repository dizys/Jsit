 ...
 public class ASTShiftExpressionVisitor
   extends Visitor
 {
   public ASTShiftExpressionVisitor(SimpleNode node, Object data)
   {
     super(node, data);
   }
   ...
   public void visitChildren(JsitParserVisitor defaultVisitor)
   {
     ...
     int i = 0;
     while ((this.node.jjtGetChild(++i) instanceof ASTAdditiveExpression))
     {
