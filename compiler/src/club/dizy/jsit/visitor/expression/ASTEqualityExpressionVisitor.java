 ...
 public class ASTEqualityExpressionVisitor
   extends Visitor
 {
   public ASTEqualityExpressionVisitor(SimpleNode node, Object data)
   {
     super(node, data);
   }
   ...
   public void visitChildren(JsitParserVisitor defaultVisitor)
   {
     ...
     int i = 0;
     while ((this.node.jjtGetChild(++i) instanceof ASTInstanceOfExpression))
     {
